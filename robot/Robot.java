...
import frc.robot.commands.AutonOpenClaw;
...
public class Robot extends TimedRobot {
  ...
  public void autonomousInit() {
    ...
    //new AutonMove(1.4,0.3,0) new AutonElevator(0.7), new WaitCommand(0.8), new AutonOpenClaw(0.778), new WaitCommand(0.8), new AutonMove(1.4,-0.3,0)
