...
public class RobotContainer {
  ...
  public static final Claw m_Claw = new Claw(Constants.clawPort);
  public static final ElevatorSubsystem m_Elevator = new ElevatorSubsystem(Constants.elevatorPort);
  public final static ArmSubsystem m_Arm = new ArmSubsystem(Constants.armPort);
  ...
  private void configureBindings() {
    ...
    buttonElevatorDown.whileTrue(new JointCommand(m_Elevator, m_Arm, 1));
    buttonElevatorDown.onFalse(new JointCommand(m_Elevator, m_Arm, 0));
